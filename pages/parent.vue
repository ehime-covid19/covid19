    ...
    return {
      items: [
        ...
        },
        {
          title: '2 感染症を疑う場合の対応',
          body:
            '〇　風邪の症状や、37.5度以上の発熱が４日以上続いている、強いだるさ（倦怠感）、息苦しさ（呼吸困難）がある場合は、各保健所にご相談ください。<br />〇  「新型コロナウイルス感染症にかかる相談窓口について」（愛媛県　保健福祉部）<br /><a href="https://www.pref.ehime.jp/h25500/documents/24madoguchi.pdf" target="_blank" rel="noopener">https://www.pref.ehime.jp/h25500/documents/24madoguchi.pdf</a>'
        },
        {
          title: '3 その他',
